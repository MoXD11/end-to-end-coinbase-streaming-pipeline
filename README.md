...
The pipeline ingests Coinbase's public event stream, transports it through **Apache Flume** and **Apache Kafka**, archives the raw events in **HDFS**, processes them in real time with **Apache Spark Structured Streaming**, stores the resulting metrics in **InfluxDB**, and visualizes everything live on a **Grafana** dashboard.
